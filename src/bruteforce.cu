...
__device__ __constant__ int dmr_rX_dev[36]        = DMR_RX_INIT;
__device__ __constant__ int dmr_rY_dev[36]        = DMR_RY_INIT;
__device__ __constant__ int dmr_rZ_dev[36]        = DMR_RZ_INIT;
__device__ __constant__ int sf_dibit_idx_dev[3][36] = DMR_SF_DIBIT_IDX_INIT;

static const int dmr_rW_host[36]        = DMR_RW_INIT;
static const int dmr_rX_host[36]        = DMR_RX_INIT;
static const int dmr_rY_host[36]        = DMR_RY_INIT;
static const int dmr_rZ_host[36]        = DMR_RZ_INIT;
static const int sf_dibit_idx_host[3][36] = DMR_SF_DIBIT_IDX_INIT;
