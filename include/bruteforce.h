...
#define RC4_SBOX_SIZE           256     // S-box entries: S[], KSA loops, identity table, CUDA tpb
#define RC4_DISCARD_BYTES       256     //RC4 keystream discard count
#define STOP_POLL_MASK          0x3FFu  //stop-poll mask (every 1024 iterations)
#define LOCAL_KEYS_FLUSH        16384   //local-keys flush threshold for atomicAdd
